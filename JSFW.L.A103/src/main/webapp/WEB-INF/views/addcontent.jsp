					...
					<div class="row">
						<div class="col-xl-12">
							...
							<div class="card mb-4">
								...
								<div class="card-body">
									<form action="${pageContext.request.contextPath }/addContent"
										method="post">
										<!-- Form Group (username)-->
										<!-- Form Row-->
										<div class="form-row">
											...
											<div class="form-group col-md-12">
												<label class="small mb-1 font-weight-bold" for="Title">Enter
													Title </label> <input class="form-control" name="Title" type="text"
													placeholder="Enter the title..." value="">
												<form:errors path="ContentDto.title" cssClass="error"></form:errors>
											</div>
										</div>
										<!-- Form Row-->
										<div class="form-row">
											...
											<div class="form-group col-md-12">
												<label class="small mb-1 font-weight-bold" for="">Brief</label>
												<textarea class="form-control" id="inputPhone" type="tel"
													rows="4" cols="50" name="Brief"
													placeholder="Enter the brief"></textarea>
												<form:errors path="ContentDto.brief" cssClass="error"></form:errors>
											</div>
											<div class="form-group col-md-12">
												<label class="small mb-1 font-weight-bold" for="Content">Content</label>
												<textarea class="form-control" id="Content" type="tel"
													rows="4" cols="50" name="Content"
													placeholder="Enter the Content..."></textarea>
												<form:errors path="ContentDto.content" cssClass="error"></form:errors>
											</div>
