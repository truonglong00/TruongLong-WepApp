				...
				<div
					...
					<h6 class="dropdown-header d-flex align-items-center">
						...
						<div class="dropdown-user-details">
							...
							<div class="dropdown-user-details-name">${member.firstName} ${member.lastName}</div>
				...
				<header
					...
					<div class="container-fluid">
						<div class="page-header-content">
							<div
								class="row align-items-center justify-content-between pt-3 mb-0">
															...
															<tbody>
																<c:forEach var="content" items="${listContents}">
																	<tr role="row" class="odd">
																		<td>${content.id}</td>
																		<td width="15%">${content.title}</td>
																		<td width="30%">${content.brief}</td>
																		<td>${content.creatDate}</td>
																		<td><button type="button"
																				class="btn border p-2 text-danger"
																				data-toggle="modal" data-target="#deleteContent">
																				Xóa</button> <a
																			href="${pageContext.request.contextPath}/editContent/${content.id}" class="btn border p-2">Edit</a>
																		</td>
																	</tr>
																		...
																		<div class="modal-dialog modal-dialog-centered"
																			...
																			<div class="modal-content">
																				<div class="modal-header">
																					<h5 class="modal-title" id="exampleModalLongTitle">You
																						really want to delete this content ?</h5>
																					<button type="button" class="close"
																						data-dismiss="modal" aria-label="Close">
																						<span aria-hidden="true">&times;</span>
																					</button>
																				</div>
																				<div class="modal-body">Please choose to
																					confirm your choice!</div>
																				<div class="modal-footer">
																					<button type="button" class="btn border mr-2"
																						data-dismiss="modal">Close</button>
																					<a
																						href="${pageContext.request.contextPath}/deleteContent/${content.id}"
																						class="btn border text-danger">Delete</a>
																				</div>
																			</div>
																		</div>
																	</div>
