								    ...
								    <form action="${pageContext.request.contextPath }/editprofile" method="post">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label class="small mb-1" for="inputFirstName">FirstName
													</label> 
													<input class="form-control" name="firstName"
													id="firstName" type="text"
													placeholder="Enter your first name"
													value="${member.firstName}">
												<form:errors path="MemberProfileDto.firstName"></form:errors>
											</div>
											<!-- Form Group (last name)-->
											<div class="form-group col-md-6">
												<label class="small mb-1" for="inputLastName">Last
													name</label> <input class="form-control" name="lastName"
													type="text" placeholder="Enter your last name"
													value="${member.lastName}">
													<form:errors path="MemberProfileDto.lastName"></form:errors>
											</div>
										</div>
										<!-- Form Row        -->
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label class="small mb-1" for="inputOrgName">Phone</label> <input
													class="form-control" name="Phone" type="text"
													placeholder="Enter your phone number"
													value="${member.phone}">
													<form:errors path="MemberProfileDto.phone"></form:errors>
											</div>
											<!-- Form Group (location)-->
											<div class="form-group col-md-6">
												...
												<input class="form-control" name="Email"
													...
													value="${member.email}">
													   <form:errors path="MemberProfileDto.email"></form:errors>
											</div>
										</div>
										<!-- Form Row-->
										<div class="form-row">
											...
											<div class="form-group col-md-12">
												...
												<textarea class="form-control" id="inputPhone" type="tel"
													rows="4" cols="50" name="Description">${member.description}</textarea>
												 <form:errors path="MemberProfileDto.description"></form:errors>
											</div>
